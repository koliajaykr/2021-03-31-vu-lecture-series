...
```{r 13, out.width="35%", fig.align='left'}
knitr::include_graphics("images/13.jpeg")
```
...
Mr. Chandrashekhar M.Wankhede, <br>Shivaji University (India)
]
...
- Dr. Bibek Datta (Team member) 
- Mr. Sandeep Kapse (Team member) 
- Mr. Remi Thomas (Team member) 
- Miss Palak Tuteja (Team member)
